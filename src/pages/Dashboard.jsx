...
export default function Dashboard() {
    ...
    function getDataLendings() {
        ...
        .then(res => {
            ...
            // membuat struktur array baru yang berisi date (tanggal format sebelumnya) dan total stuff (total dato total_stuff)
            ...
            //mengubah state checkProses menjadi true untuk men-trigger userEffect
            setCheckProses(true)
        })
        .catch(err => {
